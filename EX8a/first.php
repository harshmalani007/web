...
<!------------------- C O N T E N T   S E C T I O N ------------------------------>
            ...
            <section class="temp_section">
                ...
                <div id="men">
                    ...
                    <tr>
                       <td colspan="3" >Ara<br><input type="checkbox" name="Product[]" value="POMAPX2"> Rs.4000 </td>
                       <td>Poma<br><input type="checkbox" name="Product[]" value="ABIBAS"> Rs.5000 </td>
                ...
                <div id="women">
                    ...
                    <tr>
                       <td colspan="3" >Shiper<br><input type="checkbox" name="Product[]" value="SARA"> Rs.5000 </td>
                       <td>Lowest<br><input type="checkbox" name="Product[]" value="LOWCASTE"> Rs.4000 </td>
