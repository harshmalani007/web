<html>
    ...
    <body>
        ...
        <form method="post" action="signup-details.php">
            <div id="Form">
                <fieldset>
                    ...
                    <br>
                    <input id="submit-btn" type="submit" name="signup" value="SIGNUP">
                    
                   <p id="Already">ALREADY A MEMBER?? <a href="index.php">LOG IN</a></p> 
